"""
In order to transform a variable font file to a static one with specific weight do:
`python3 mutator.py [variable file] wght=[100 -> 900] -o [static file]
from:
https://typedrawers.com/discussion/2565/generating-static-instances-from-variable-font-file
"""
